...
PICS = (environ.get('PICS', 'https://i.ibb.co/ZpXsg4Qh/739bbcf07c15.jpg https://i.ibb.co/yBBjTyGL/d3114b6441c6.jpg')).split()  # Sample pic
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002726832996'))  # Log channel id (make sure bot is admin)
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002056271783 -1002824643553')  # Channel/Group ID for force sub (make sure bot is admin)
...
AUTH_CHANNEL = [int(fch) if id_pattern.search(fch) else fch for fch in environ.get('AUTH_CHANNEL', '-1002056271783 -1002824643553').split()]
MULTI_FSUB = [int(channel_id) for channel_id in environ.get('MULTI_FSUB', '-1002056271783 -1002824643553').split() if re.match(r'^-?\d+$', channel_id)]  # Channel for force sub (make sure bot is admin)
...
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://NARUTO:NARUTO@cluster0.6nlqzsy.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DATABASE_URI2 = environ.get('DATABASE_URI2', "mongodb+srv://NARUTU:NARUTU@cluster0.ysuut58.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
